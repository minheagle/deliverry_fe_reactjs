  ...
  return (
    ...
    >
      ...
      <div className="col-span-10">
        <div className="w-full flex justify-start items-center pt-32 pb-32">
          <div className="w-1/3 flex flex-col justify-start items-center gap-4 bg-white p-8 rounded">
            <Formik
                      ...
                      {errors.account ? (
                        <div className="w-full flex justify-end items-center gap-2 text-primary">
                          <FontAwesomeIcon
                            ...
                            className=""
                          />
                          <span className="text-sm">{errors.account}</span>
                        </div>
                      ) : (
                        ""
                      )}
            ...
            <Link to={ROUTES.PUBLIC.AUTH.REGISTER}>
